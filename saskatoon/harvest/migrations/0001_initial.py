# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-23 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner_no_fruit', models.BooleanField(default=False, verbose_name='Owner does not want his share of fruits')),
                ...
                ('leader_need_help', models.BooleanField(default=False, help_text='Check the About field for details', verbose_name='Pick leader needs extra help')),
                ('about', models.TextField(blank=True, help_text='If any help is needed from volunteer pickers, please describe them in this box.', max_length=1000, null=True, verbose_name='About')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('is_active', models.BooleanField(default=b'True', help_text='Harvest in this property is authorized for the current season', verbose_name='Is active')),
                ...
                ('publishable_location', models.CharField(blank=True, help_text='Aproximative location, do not make public the real address.', max_length=50, null=True, verbose_name='Publishable location')),
